          ...
          <div className="thank-you-wrapper text-center">
            <div className="thank-you-container text-center">
              <div className="thank-you-text">
                <img src="/images/logo/failed.png" alt="bg-image" />
                <h2>{t("Sorry! Your payment has been Cancel")}</h2>
              </div>
            </div>
          </div>
        </div>
...
export const getServerSideProps = async ({ req }) => {
  ...
  const metaData = await getServerApiRequest("get-meta", {'meta_type' : 1, 'page' : 17});
  return {
    props: {
