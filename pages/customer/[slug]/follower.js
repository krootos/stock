...
const CustomerDetails = (props) => {
  ...
  useEffect(() => {
    props.getCustomerFollowerAction(props.customer_details.customer.id);
  }, [props.customer_details.customer.id]);
  const handleChange = (value) => {
    props.getCustomerFollowerAction(
      props.customer_details.customer.id,
          ...
          <div className="profile-header-wrapper">
            <div className="container">
              <div className="user-profile-header">
                ...
                {userInfo?.id != props.customer_details.customer.id && (
                  <div className="right">
                    <button
          ...
          <div className="follower-area">
            <div className="container">
              <div className="row g-4 gallery">
                {props.customer_followers?.data?.length === 0 ? (
                  <h2 className="text-center pt-5">{t("No Data Found")}</h2>
                ) : (
                  props.customer_followers?.data?.map((item, i) => (
              ...
              {props.customer_followers?.total >
                props.customer_followers?.per_page && (
                <nav className="filter-pagination mt-35">
                  <ReactPaginate
                    ...
                    pageRangeDisplayed={props.customer_followers?.per_page}
...
const mapStateToProps = (state) => ({
  customer_followers: state.common.customer_followers,
});
